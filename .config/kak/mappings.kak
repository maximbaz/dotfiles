...
map global user -docstring 'clip-paste (before)'  p      'o<esc>!xclip -selection clipboard -o<ret><a-d>'
map global user -docstring 'clip-paste (after)'   P      'O<esc><a-!>xclip -selection clipboard -o<ret><a-d>'
